...
resultado = numero_1 * numero_2
print("A multiplicação do número 1 pelo numero 2 é",resultado)

resultado = numero_1 / numero_2
print("A divisão do número 1 pelo numero 2 é",resultado)

resultado = numero_1 ** numero_2
print("O número 1 elevado pelo numero 2 é",resultado)

resultado = numero_1 // numero_2
print("A divisão inteira do número 1 pelo numero 2 é",resultado)

resultado = numero_1 % numero_2
print("O resto de divisão do número 1 pelo numero 2 é",resultado)